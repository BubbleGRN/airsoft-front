<template>
  ...
  >
    ...
    >
      <v-text
        class="my-animation custom-text"
        style="font-size: 5rem; position: relative; top: -30px; left: 20px"
      >
        {{ item.text }}
      </v-text>
    </v-carousel-item>
      ...
      <v-row>
        <v-col cols="12" md="12" style="margin-left: 7rem">
          <v-card style="width: 93%">
            <v-toolbar color="primary" class="d-flex pt-5">
              <v-spacer></v-spacer>
              <div class="d-flex flex-row w-100">
                <v-tabs
                  v-model="tab"
                  direction="horizontal"
                  class="d-flex bg-primary justify-space-around full-width px-5"
                  color="white"
                  dark
                  flat
            ...
            <v-tabs-window v-model="tab" style="border: 20px solid #2d4b2a">
                  ...
                  <v-row>
                    <v-col cols="6" class="px-10">
                      ...
                      <p class="mb-10" style="line-height: 40px">
                        ...
                        彈藥：氣槍通常使用BB彈作為彈藥，BB彈是小型塑膠球，直徑大約為6mm。這種彈藥的優點是便宜、輕便且較為安全。<br />

                        精度與射程：雖然氣槍的射程通常不及真實武器，但高品質的氣槍仍能提供相對精確的射擊。射程通常在30至50米之間，但也有一些高端型號能夠達到更遠的射程。<br />
                ...
                <v-card flat class="pa-6 scrollable-card px-15" style="max-height: 1352px">
                  ...
                  <div>
                    ...
                    <p class="mb-10" style="line-height: 40px">
                      ...
                      在某些遊戲中，護手還可能提高角色的攀爬、挖掘或其他操作能力。<br />
                    </p>
                  </div>
              ...
              <v-tabs-window-item value="option-4">
                <v-card flat class="pa-6 scrollable-card px-15" style="max-height: 1352px">
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    ...
                    <br />
                    1. 布料/皮革頭盔：
                    這類頭盔通常是遊戲初期可以獲得的護具，防護效果較弱，但重量輕，適合遊戲初期使用。<br />
                    2. 鋼鐵/金屬頭盔：
                    這些頭盔通常提供更高的防護能力，能有效抵擋來自敵人武器（如槍械、弓箭等）的傷害。金屬頭盔在遊戲中往往需要更高的製作成本或更長的時間來解鎖。<br />
                    3. 戰術頭盔：
                    戰術頭盔通常是專為軍事或極端環境設計，能有效保護頭部並提供額外的功能，如夜視、瞄準輔助等。在一些遊戲中，這類頭盔可能還附帶防爆設計或能承受更強烈的衝擊。<br />
                    4. 防彈頭盔：
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    ...
                    1.
                    增加視野範圍：例如，一些高科技頭盔會提供增強視野的功能（例如夜視模式、紅外線視覺等），讓玩家能在黑暗或隱蔽的環境中更容易發現敵人或物品。
                    <br />
                    2.
                    提升精準度：有些頭盔會與其他裝備（如瞄準鏡）配合使用，提供更高的射擊精準度或增加瞄準輔助。
                    <br />
                    3.
                    抗衝擊與防爆：某些頭盔會加強抗衝擊性，減少來自爆炸物的傷害，或降低環境危險（如化學氣體、沙塵等）的影響。
                    <br />
                  </p>
              ...
              <v-tabs-window-item value="option-5">
                <v-card flat class="pa-6 scrollable-card px-15" style="max-height: 1352px">
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    1.
                    標準塑膠BB彈：最常見的BB彈，使用普通的塑膠材質，通常是白色或黑色。這些彈藥是最便宜且最常見的選擇。<br />
                    2. 高性能BB彈：這些BB彈可能會使用更高品質的塑料或合成材料，對於某些高精度的
                    Airsoft 玩家來說，這些BB彈的飛行穩定性和精度更好。常見品牌如 G&G 或 MadBull
                    等會製造這些較為精緻的BB彈。<br />
                    3. 生物降解BB彈：為了保護環境，越來越多的 Airsoft
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    ...
                    遊戲中。 <br />
                    2.
                    黑色：一些高端的BB彈，通常用於需要更高隱蔽性的環境中，這樣不容易被對方發現。黑色BB彈通常會在黑暗的環境中使用較多。
                    <br />
                    3.
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    在 Airsoft
                    遊戲中，選擇合適的BB彈對於射擊的精度、射程和遊戲表現有很大的影響。以下是一些選擇BB彈時需要注意的因素：
                    <br />
                    1. 槍械類型：不同的 Airsoft 槍支（例如
                    電動槍、氣動槍、彈簧槍）對BB彈的需求會有所不同。一般來說，電動槍和氣槍對BB彈的要求會更高，需要選擇較高品質的BB彈來保證穩定性和精度。
                    <br />
                    2.
                    射擊距離與精度：若你偏好遠距離射擊，選擇較重的BB彈會有助於提高射程和精度。而如果是在近距離的激烈戰鬥中，輕型的BB彈可能更合適，因為它們射速更快。
                    <br />
                    3.
                    遊戲環境：在室內的狹小空間或高密度區域，通常會選擇較輕的BB彈，以便快速射擊；在戶外較開闊的場地，則會使用較重的BB彈來應對風速等環境因素的影響。
                    <br />
                  </p>
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    1.
                    存儲：BB彈應保存在乾燥、陰涼的地方，避免潮濕或高溫，因為這樣可能會影響BB彈的品質或導致其變形。<br />
                    2.
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    ...
                    等品牌生產高品質的BB彈，這些品牌的BB彈在精度、穩定性和耐用性上都非常優秀，受到許多
                    Airsoft 玩家推崇。
                  </p>
                </v-card>
              </v-tabs-window-item>
              ...
              <v-tabs-window-item value="option-6">
                <v-card flat class="pa-6 scrollable-card px-15" style="max-height: 1352px">
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    1.
                    額外彈匣：在遊戲中，擁有足夠的彈匣非常重要，尤其是在長時間的對抗中。不同的槍支會有不同型號的彈匣，因此玩家通常會準備多個備用彈匣。<br />
                    2.
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    ...
                    防護眼鏡可以有效防止BB彈或碎片傷害眼睛。通常會有透氣設計，避免起霧。 <br />
                    2.
                    面罩：如果玩家不想僅僅依賴眼鏡保護面部，可以選擇佩戴全臉面罩來防護面部及下巴，這樣能夠有效保護整個面部不受撞擊。
                    <br />
                  </p>
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    1. 對講機：在大型的 Airsoft
                    遊戲中，隊伍之間的協調至關重要，對講機能讓隊員之間保持聯繫，即使在聲音很大的環境下也能溝通。
                    <br />
                    2.
                    耳機：有些對講機會搭配耳機，這樣玩家可以在不露出耳朵的情況下聽到指令或隊友的聲音，並減少外界噪音的干擾。
                    <br />
                  </p>
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    1.
                    手電筒：在暗光環境或夜間遊戲中，手電筒可以提供必要的照明，幫助玩家識別周圍的環境。<br />
                    2.
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    1.
                    迷彩網：用於隱蔽或遮掩，特別是在叢林或森林等地形中，迷彩網可以幫助玩家更好地與環境融合。<br />
                    2.
                    假面具/偽裝服：有些玩家會選擇穿戴特殊的偽裝服，這有助於提高隱蔽性，避免被對手輕易發現。<br />
                  </p>
                </v-card>
              </v-tabs-window-item>
              ...
              <v-tabs-window-item value="option-7">
                <v-card flat class="pa-6 scrollable-card px-15" style="max-height: 1352px">
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    1.
                    額外彈匣：在長時間的對抗中，額外的彈匣是非常重要的。確認租借的裝備是否有額外彈匣可以提供，並了解如何快速更換彈匣。<br />
                    2. BB彈：某些地點可能會提供
                    BB彈，但在一些場合你可能需要自備。確保你所使用的BB彈與所租借的武器匹配，並注意重量和尺寸的選擇，避免使用不合規格的彈藥。<br />
                    3.
                  ...
                  <p class="mb-10" style="line-height: 40px">
                    1.
                    租借協議：大部分場地都會有裝備租借協議，明確規範租借期間的責任、損壞賠償、設備使用等條款。在租借裝備前，詳細閱讀協議內容，確保自己了解條款，避免出現不必要的糾紛。<br />
                    2.
  ...
  <div id="main-content" style="margin-top: 750px">
    <v-text
      class="custom-text"
      style="text-align: center; position: absolute; top: 220px; width: 100vw; color: #2d4b2a"
      >關於我們 About Us</v-text
    >
    <v-card
      style="
        width: 90vw;
    ...
    >
      <v-card-text>
        <v-row>
          <v-col cols="6"
            ><v-img src="../../img/soldier2.jpg"></v-img>
            <v-subtitle style="color: red">圖片僅供參考</v-subtitle></v-col
          >
          <v-col cols="6">
            <h2 style="font-size: 20px">
              Survivor's Quest
              是一款結合生存冒險和策略劇情的遊戲，為玩家提供既具挑戰性又充滿故事性的體驗。在這裡，你不僅僅要面對自然的極限考驗，還要解開一個個謎題、識破隱藏在隊友中的敵人，並在充滿陰謀和驚險的環境中生存下來。
            </h2>
            <br /><br />
            ...
            <br />
            在 Survivor's Quest
            中，你將被置身於一個神秘的荒野，這裡充滿了危險和謎題。你必須利用各種生存技能來建造庇護所、尋找食物，並與其他玩家合作或對抗。然而，這場生存遊戲不僅僅是物理上的挑戰——每一個玩家都有自己的秘密，每個選擇背後都有深刻的故事和陰謀。像《狼人殺》一樣，你可能發現自己與身邊的隊友並不完全是一條船上的人，而是背後藏有各自的目的和動機。<br /><br />
            ...
            1.
            生存挑戰：玩家需要在充滿資源限制和險惡環境的世界中生存下來。建造庇護所、尋找食物和水源、抵禦野生動物的襲擊——這些基本的生存技能將是你成功的關鍵。<br /><br />
            2.
            策略與劇情：隨著遊戲進程的推進，玩家會被捲入一場錯綜複雜的陰謀與謎題當中。誰是隊中的間諜？誰在隱藏自己的真實身份？每一個選擇都可能改變你的命運。類似《狼人殺》的機制，讓每個玩家都處於緊張的心理博弈中，你是否能揭露真相，還是成為別人的犧牲品？<br /><br />
            <h2>我們的願景</h2>
            <br />
            我們希望 Survivor's Quest
            不僅是一款生存遊戲，更是一個充滿互動與策略的劇情冒險平台。在這裡，玩家的選擇會影響故事的走向，每一場遊戲都是一次全新的冒險和挑戰。我們的目標是創造一個讓玩家不斷思考、探索和反轉局勢的環境，讓每一個遊戲體驗都充滿未知與驚喜。<br /><br />
    ...
    <v-row>
      <v-col cols="6" style="padding-left: 50px">
        <div style="text-align: center">
          <v-icon style="font-size: 50px">mdi-hand-pointing-down</v-icon
          ><v-text class="custom-text">From Silo Entertainment</v-text>
        </div>
      ...
      <v-col cols="6" style="padding-right: 60px">
        ...
        <div style="text-align: center">
          <v-icon style="font-size: 50px">mdi-hand-pointing-up</v-icon
          ><v-text class="custom-text">From Airsoft Alfonse</v-text>
        </div>
      </v-col>
    </v-row>
  </v-card>
...
#main-content {
  background: url(../../img/paper_background.png) no-repeat center/cover;
  width: 100%;
  height: 1900px;
  position: relative;
  top: -200px;
